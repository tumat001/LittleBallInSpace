...
const MIN_LAUNCH_FORCE__LINE_COLOR := Color(78/255.0, 123/255.0, 253/255.0, 0.6)
const CHARGING_01_LAUNCH_FORCE__LINE_COLOR := Color(100/255.0, 253/255.0, 77/255.0, 0.6)
const MAX_LAUNCH_FORCE__LINE_COLOR := Color(255/255.0, 128/255.0, 0/255.0, 0.6)
