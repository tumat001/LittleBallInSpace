...
func _init_player_dead_vis_status__check_for_GE():
	if !SingletonsAndConsts.current_game_elements.is_player_spawned():
		...
		_init_player_dead_vis_status__player_spawned(SingletonsAndConsts.current_game_elements.get_current_player())
	
	

func _on_player_spawned(arg_player):
	_init_player_dead_vis_status__player_spawned(arg_player)
	

func _init_player_dead_vis_status__player_spawned(arg_player):
