...
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIUS__NORMAL = 0.75
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_THICKNESS__NORMAL = 0.6
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_COLOR__NORMAL = Color("#6D0103")
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_BRIGHTNESS__NORMAL = 2.0
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ANGULAR_SPEED__NORMAL = -0.1
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIAL_SPEED__NORMAL = 0.05
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ALPHA__NORMAL = 0.2

const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIUS__BRIGHTENED = 0.75
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_THICKNESS__BRIGHTENED = 0.6
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_COLOR__BRIGHTENED = Color("#9533FF")
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_BRIGHTNESS__BRIGHTENED = 2.0
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ANGULAR_SPEED__BRIGHTENED = -0.15
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIAL_SPEED__BRIGHTENED = 0.05
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ALPHA__BRIGHTENED = 0.2
...
func _create_background_color_rect_shader(arg_deferred_add_child : bool):
	...
	match _current_background_type:
		BackgroundTypeIds.LAYOUT_SPECIALS, BackgroundTypeIds.LEVEL__SPECIAL_01:
...
func _create_shader_mat_based_on_curr_background_type(arg_insta_set_properties : bool):
	...
	match _current_background_type:
		...
		BackgroundTypeIds.LAYOUT_SPECIALS:
			...
			if arg_insta_set_properties or details[1]:
				...
				_insta_set_properties__TYPE_LAYOUT_SPECIALS(material_sh)
...
func _insta_set_properties__TYPE_LAYOUT_SPECIALS(material_sh):
	_TYPE_CIRCULAR_NOISE__set_shader_properties(material_sh, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIUS__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_THICKNESS__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_COLOR__NORMAL,
			STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_BRIGHTNESS__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ANGULAR_SPEED__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIAL_SPEED__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ALPHA__NORMAL)
...
func _update_shader_based_on_is_star_collected():
	if _is_star_collected:
		...
		match _current_background_type:
			...
			BackgroundTypeIds.LAYOUT_SPECIALS:
				_TYPE_CIRCULAR_NOISE__tween_rect_shader(STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIUS__BRIGHTENED, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_THICKNESS__BRIGHTENED, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_COLOR__BRIGHTENED, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_BRIGHTNESS__BRIGHTENED, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ANGULAR_SPEED__BRIGHTENED, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIAL_SPEED__BRIGHTENED, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ALPHA__BRIGHTENED)
		...
		match _current_background_type:
			...
			BackgroundTypeIds.LAYOUT_SPECIALS:
				_TYPE_CIRCULAR_NOISE__tween_rect_shader(STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIUS__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_THICKNESS__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_COLOR__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_BRIGHTNESS__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ANGULAR_SPEED__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_RADIAL_SPEED__NORMAL, STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ALPHA__NORMAL)
