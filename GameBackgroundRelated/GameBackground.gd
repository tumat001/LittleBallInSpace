...
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ANGULAR_SPEED__NORMAL = -0.2
...
const STYPE_CIRCULAR_01__LAYOUT_SPECIALS__SHADER_ANGULAR_SPEED__BRIGHTENED = -0.2
