...
func _on_after_game_start_init():
	...
	if !SingletonsAndConsts.if_level_id_has_single_game_session_persisting_data(StoreOfLevels.LevelIds.LEVEL_02__STAGE_SPECIAL_1):
		...
		var modi = game_elements.player_modi_manager.get_modi_or_null(StoreOfPlayerModi.PlayerModiIds.LAUNCH_BALL)
		
		_ball = modi.create_ball__for_any_use(true)
		_ball.has_finite_lifespan = false
		_ball.global_position = Vector2(1000, 1000)
		_ball.destroy_self_caused_by_destroying_area_region(_obj_destroying_area)
		
		modi.set_current_ball_count(modi.get_current_ball_count() - 1)
		
		_tileset.toggle_fill_to_unfilled_and_vise_versa()
...
#const OBJ_IDENTIF__PCA = "RewindData_PCA"

var _ball
var _player
onready var _button = $ObjectContainer/Object_InteractableButton_Red
onready var _tileset = $TileContainer/BaseTileSet_Red
onready var _obj_destroying_area = $AreaRegionContainer/ObjectDestroyingAreaRegion
onready var _pca = $AreaRegionContainer/PlayerCaptureAreaRegion
...
#
#		if tileset_data.has("cell_save_data"):
#			print(tileset_data["cell_save_data"])
#
#		## PCA
#		var pca_data = object_name_to_rewind_data[OBJ_IDENTIF__PCA]
#		obj_to_rewind_data[_pca] = pca_data
#
#		######
...
#	_tileset.started_rewind()
#	_tileset.load_into_rewind_save_state(tileset_data)
#	_tileset.ended_rewind()
#
#	# PCA
#	var pca_data = last_object_name_to_rewind_data[OBJ_IDENTIF__PCA]
#	_pca.started_rewind()
#	_pca.load_into_rewind_save_state(pca_data)
#	_pca.ended_rewind()
#
...
#
#			var tileset_data = arg_rewindable_obj_to_save_state_map[obj]
#			if tileset_data.has("cell_save_data"):
#				print("saved data: %s" % tileset_data["cell_save_data"])
#
#
#		elif obj.get("is_player_capture_area_region"):
#			relevant_object_name_to_rewind_data[OBJ_IDENTIF__PCA] = arg_rewindable_obj_to_save_state_map[obj]
#
#
