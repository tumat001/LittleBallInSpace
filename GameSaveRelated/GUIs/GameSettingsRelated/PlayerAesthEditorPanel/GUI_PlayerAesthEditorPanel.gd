...
func _ready():
	## BODY TEXTURE
	body__color_picker_button.configure_self_to_update_to_GSettingsM_presets(GameSettingsManager.shared_commnons__all_color_presets__var_name, GameSettingsManager.set_shared_commnons__all_color_presets__func_name, GameSettingsManager.shared_commons__all_color_presets__changed__signal_name)
	...
	face_screen__color_picker_button.configure_self_to_update_to_GSettingsM_presets(GameSettingsManager.shared_commnons__all_color_presets__var_name, GameSettingsManager.set_shared_commnons__all_color_presets__func_name, GameSettingsManager.shared_commons__all_color_presets__changed__signal_name)
	...
	face_expression__color_picker_button.configure_self_to_update_to_GSettingsM_presets(GameSettingsManager.shared_commnons__all_color_presets__var_name, GameSettingsManager.set_shared_commnons__all_color_presets__func_name, GameSettingsManager.shared_commons__all_color_presets__changed__signal_name)
