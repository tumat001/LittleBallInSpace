...
onready var has_hidden_container = $VBoxContainer/MarginContainer/ContentContainer/VBoxContainer/HasHiddenContainer
onready var controls_vbox = $VBoxContainer/MarginContainer/ContentContainer/VBoxContainer/ControlsContainerMarginer/ControlsVBox
