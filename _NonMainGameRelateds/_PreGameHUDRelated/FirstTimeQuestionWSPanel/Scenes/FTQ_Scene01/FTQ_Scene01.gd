...
func start_display():
	...
	_current_custom_steppable_control = ftq_custom_label
	ftq_custom_label.start_display_of_descs(1.25, 1.5, null, 0, 18)
...
func _on_display_of_desc_finished__first_line(custom_char_count_to_show_upto, arg_metadata):
	...
	ftq_custom_label.start_display_of_descs(1.75, 2.5, null, 18, total_char)
