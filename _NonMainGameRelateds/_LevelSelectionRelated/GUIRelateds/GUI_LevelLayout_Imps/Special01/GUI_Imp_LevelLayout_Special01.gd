...
func _ready():
	...
	level_04__tile.level_details = StoreOfLevels.generate_or_get_level_details_of_id(StoreOfLevels.LevelIds.LEVEL_04__STAGE_SPECIAL_1)
	...
	layout_spec_02__tile.level_layout_details = StoreOfLevelLayouts.get_or_construct_layout_details(StoreOfLevelLayouts.LevelLayoutIds.LAYOUT_SPECIAL_02)
	layout_spec_02__tile.layout_ele_id_to_put_cursor_to = 0
...
#	game_background.set_current_background_type(GameBackground.BackgroundTypeIds.LAYOUT_SPECIALS, arg_is_instant_in_transition)
#
#
##
#
